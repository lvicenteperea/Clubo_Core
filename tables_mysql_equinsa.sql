CREATE TABLE `eqn__hissesbd` (
    ...
    PRIMARY KEY (`fechorini`, `nompc`, `nomapl`, `ruteje`)
);

CREATE TABLE `eqn__ver` (
...
CREATE TABLE `eqn_apa` (
    ...
    PRIMARY KEY (`codins`, `tip`, `num`)
);

CREATE TABLE `eqn_apeman` (
    `codins` SMALLINT NOT NULL,
    `fechor` DATETIME NOT NULL,
    ...
    PRIMARY KEY (`codins`, `fechor`, `horfechor`, `tipapa`, `numapa`)
);

CREATE TABLE `eqn_c_condetcob` (
...
CREATE TABLE `eqn_camapa` (
    ...
    `ord` SMALLINT NULL,
    PRIMARY KEY (`codins`, `tipapa`, `numapa`, `tipapacam`, `numapacam`)
);

CREATE TABLE `eqn_capima` (
    `codins` SMALLINT NOT NULL,
    `fechor` DATETIME NOT NULL,
    `horfechor` SMALLINT NOT NULL,
    `tipapa` SMALLINT NOT NULL,
    ...
    `mat` VARCHAR(12) NULL,
    PRIMARY KEY (`codins`, `fechor`, `horfechor`, `tipapa`, `numapa`, `numcam`)
);

CREATE TABLE `eqn_car` (
    `codins` SMALLINT NOT NULL,
    `cod` SMALLINT NOT NULL,
    `des` VARCHAR(40) NOT NULL,
    ...
    `numapa` SMALLINT NOT NULL,
    `vis` SMALLINT NULL,
    PRIMARY KEY (`codins`, `cod`)
);

CREATE TABLE `eqn_cli` (
    `codins` SMALLINT NOT NULL,
    `cod` INT NOT NULL,
    `nom` VARCHAR(40) NULL,
    `ape` VARCHAR(60) NULL,
...
CREATE TABLE `eqn_cligrucli` (
    `codins` SMALLINT NOT NULL,
    `codcli` INT NOT NULL,
    `codinsgrucli` SMALLINT NOT NULL,
    `codgrucli` SMALLINT NOT NULL,
    PRIMARY KEY (`codins`, `codcli`, `codinsgrucli`, `codgrucli`)
);

CREATE TABLE `eqn_cob` (
    `codins` SMALLINT NOT NULL,
...
CREATE TABLE `eqn_comeve` (
    `codins` SMALLINT NOT NULL,
    `ideeve` VARCHAR(60) NOT NULL,
    `fechor` DATETIME NOT NULL,
    `datadi` VARCHAR(512) NULL,
    PRIMARY KEY (`codins`, `ideeve`)
);

CREATE TABLE `eqn_con` (
    `codins` SMALLINT NOT NULL,
    `cod` SMALLINT NOT NULL,
...
CREATE TABLE `eqn_decperope` (
    `codins` SMALLINT NOT NULL,
    `codope` SMALLINT NOT NULL,
    `codper` SMALLINT NOT NULL,
    `acc` SMALLINT NULL,
    PRIMARY KEY (`codins`, `codope`, `codper`)
);

CREATE TABLE `eqn_detcob` (
    `codins` SMALLINT NOT NULL,
    ...
    `saldis` FLOAT NULL,
    `codrefext` VARCHAR(32) NULL,
    PRIMARY KEY (`codins`, `codcob`, `ord`)
);

CREATE TABLE `eqn_detopecaj` (
    `codins` SMALLINT NOT NULL,
    ...
    PRIMARY KEY (`codins`, `codopecaj`, `ele`)
);

CREATE TABLE `eqn_entsal` (
    `codins` SMALLINT NOT NULL,
    `fechor` DATETIME NOT NULL,
    `horfechor` SMALLINT NOT NULL,
    `tipapa` SMALLINT NOT NULL,
    ...
    `codrefext` VARCHAR(32) NULL,
    `ideeve` VARCHAR(20) NULL,
    PRIMARY KEY (`codins`, `fechor`, `horfechor`, `tipapa`, `numapa`, `codtipsop`, `idepro`, `verpro`)
);

CREATE TABLE `eqn_enu` (
    `codins` SMALLINT NOT NULL,
...
CREATE TABLE `eqn_envinc` (
    `codins` SMALLINT NOT NULL,
    `codtipinc` SMALLINT NOT NULL,
    `des` VARCHAR(1024) NOT NULL,
    PRIMARY KEY (`codins`, `codtipinc`)
);

CREATE TABLE `eqn_equgruproins` (
    `codins` SMALLINT NOT NULL,
    `codinsaje` SMALLINT NOT NULL,
    `codgruproaje` SMALLINT NOT NULL,
    `codgrupro` SMALLINT NOT NULL,
    PRIMARY KEY (`codins`, `codinsaje`, `codgruproaje`)
);

CREATE TABLE `eqn_fac` (
    `codins` SMALLINT NOT NULL,
    `cod` VARCHAR(20) NOT NULL,
    `codcob` VARCHAR(20) NOT NULL,
    `fechor` DATETIME NOT NULL,
...
CREATE TABLE `eqn_fes` (
    `codins` SMALLINT NOT NULL,
    `dia` SMALLINT NOT NULL,
    `mes` SMALLINT NOT NULL,
    `nom` VARCHAR(50) NOT NULL,
    PRIMARY KEY (`codins`, `dia`, `mes`)
);

CREATE TABLE `eqn_frahor` (
    `codins` SMALLINT NOT NULL,
    ...
    PRIMARY KEY (`codins`, `codhor`, `num`)
);

CREATE TABLE `eqn_fratar` (
    `codins` SMALLINT NOT NULL,
    ...
    PRIMARY KEY (`codins`, `codtar`, `num`)
);

CREATE TABLE `eqn_grucli` (
    `codins` SMALLINT NOT NULL,
    `cod` SMALLINT NOT NULL,
    `nom` VARCHAR(50) NULL,
    `des` VARCHAR(128) NULL,
...
CREATE TABLE `eqn_inc` (
    ...
    `ideeve` VARCHAR(20) NULL,
    PRIMARY KEY (`codins`, `fechor`, `horfechor`, `tipapa`, `numapa`, `codtipinc`)
);

CREATE TABLE `eqn_inssis` (
    `codins` SMALLINT NOT NULL,
    PRIMARY KEY (`codins`)
);

CREATE TABLE `eqn_lisnegmat` (
    `codins` SMALLINT NOT NULL,
    `mat` VARCHAR(12) NOT NULL,
    `obs` VARCHAR(250) NULL,
    `codope` SMALLINT NOT NULL,
    `fechor` DATETIME NOT NULL,
    PRIMARY KEY (`codins`, `mat`)
);

CREATE TABLE `eqn_lisnegpro` (
    `codtipsop` SMALLINT NOT NULL,
    `idepro` VARCHAR(20) NOT NULL,
    `codinspro` SMALLINT NOT NULL,
    `numpro` VARCHAR(12) NOT NULL,
    ...
    `codope` SMALLINT NULL,
    `fechor` DATETIME NOT NULL,
    PRIMARY KEY (`codtipsop`, `idepro`)
);

CREATE TABLE `eqn_lispre` (
    `codins` SMALLINT NOT NULL,
    `cod` SMALLINT NOT NULL,
    `des` VARCHAR(40) NOT NULL,
...
CREATE TABLE `eqn_manpro` (
    ...
    `ideeve` VARCHAR(20) NULL,
    PRIMARY KEY (`codins`, `fechor`, `horfechor`, `tipapa`, `numapa`, `codtipsop`, `idepro`, `codtipmanpro`, `verpro`)
);

CREATE TABLE `eqn_ope` (
    `codins` SMALLINT NOT NULL,
    `cod` SMALLINT NOT NULL,
...
CREATE TABLE `eqn_opetarcre` (
    ...
    `imp` FLOAT NOT NULL,
    PRIMARY KEY (`codins`, `num`)
);

CREATE TABLE `eqn_parcon` (
    `codins` SMALLINT NOT NULL,
    `nom` VARCHAR(60) NOT NULL,
    `val` TEXT NOT NULL,
    PRIMARY KEY (`codins`, `nom`)
);

CREATE TABLE `eqn_paslispre` (
    `codins` SMALLINT NOT NULL,
    `codlispre` SMALLINT NOT NULL,
    `num` SMALLINT NOT NULL,
    `dur` DATETIME NULL,
    ...
    `maximp` FLOAT NULL,
    PRIMARY KEY (`codins`, `codlispre`, `num`)
);

CREATE TABLE `eqn_perope` (
    `codins` SMALLINT NOT NULL,
    `codope` SMALLINT NOT NULL,
    `codper` SMALLINT NOT NULL,
    PRIMARY KEY (`codins`, `codope`, `codper`)
...
CREATE TABLE `eqn_polacc` (
    ...
    `forcodtar` SMALLINT NULL,
    PRIMARY KEY (`codins`, `codgrupro`, `tipapa`, `numapa`)
);

CREATE TABLE `eqn_proencir` (
    `codtipsop` SMALLINT NOT NULL,
    `idepro` VARCHAR(20) NOT NULL,
    `codinspro` SMALLINT NOT NULL,
    `numpro` VARCHAR(12) NOT NULL,
...
CREATE TABLE `eqn_profuecir` (
    ...
    `destiecob` DATETIME NULL,
    `locres` VARCHAR(20) NULL,
    PRIMARY KEY (`codtipsop`, `idepro`, `verpro`)
);

CREATE TABLE `eqn_rec` (
    `codins` SMALLINT NOT NULL,
    `cod` SMALLINT NOT NULL,
    `des` VARCHAR(20) NULL,
...
CREATE TABLE `eqn_regaud` (
    ...
    PRIMARY KEY (`codins`, `fechor`, `horfechor`, `tipapa`, `numapa`, `codope`, `tipopeaud`)
);

CREATE TABLE `eqn_regcon` (
    `codins` SMALLINT NOT NULL,
    `fechor` DATETIME NOT NULL,
    `horfechor` SMALLINT NOT NULL,
    ...
    PRIMARY KEY (`codins`, `fechor`, `horfechor`, `codcon`)
);

CREATE TABLE `eqn_regpreusu` (
    `codins` SMALLINT NOT NULL,
    ...
    `val` TEXT NOT NULL,
    PRIMARY KEY (`codins`, `nomusu`, `nomcla`, `nomval`)
);

CREATE TABLE `eqn_remrecdom` (
    `codins` SMALLINT NOT NULL,
    `num` INT NOT NULL,
...
CREATE TABLE `eqn_renpro` (
    ...
    PRIMARY KEY (`codins`, `codtipsop`, `idepro`, `initra`)
);

CREATE TABLE `eqn_res` (
    `codins` SMALLINT NOT NULL,
    ...
    `ideage` VARCHAR(16) NULL,
    PRIMARY KEY (`codins`, `loc`)
);

CREATE TABLE `eqn_tar` (
    `codins` SMALLINT NOT NULL,
    `cod` SMALLINT NOT NULL,
    `des` VARCHAR(40) NOT NULL,
...
CREATE TABLE `eqn_tottur` (
    ...
    PRIMARY KEY (`codins`, `codtur`, `codtot`, `subcodtot`)
);

CREATE TABLE `eqn_traerrsis` (
    `fechor` DATETIME NOT NULL,
